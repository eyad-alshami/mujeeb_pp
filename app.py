...
Api = {u'Ask.api': u"عذراً، لم أفهم ما قلته للتو."
    ...
    , u'Mujeeb.services': u"يمكنني أن أبني عميل محادثة خاصاً بعملك أو خدمتك"
    ,
       u'Mujeeb.uses': u"سيتمكن عملائك من استعمال خدمتك بشكل غير مسبوق، وسيمكنهم التحدث مع عميل المحادثة الخاص بك والتفاعل مع خدماتك دون انتظار وفي أي وقت."
